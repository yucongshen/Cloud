...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<%=basePath %>css/login_style.css">
    ...
    <body oncontextmenu="return false" style="background-image: url('<%=basePath %>/img/2.jpg');">
        ...
        <div class="page-container">
            ...
            <form action="<%=basePath %>login" method="post">
				...
				<div>
					<input type="text" name="userName" class="userid" placeholder="Userid" autocomplete="off"/>
				</div>
                <div>
            ...
            <a href="<%=basePath%>registPage" style="color: white;">新用户注册</a>
            <div class="connect">
                <p>If we can only encounter each other rather than stay with each other,then I wish we had never encountered.</p>
				<p style="margin-top:20px;">如果只是遇见，不能停留，不如不相见。</p>
            </div>
        </div>
