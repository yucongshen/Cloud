	...
	<script>
		BUI.use('common/main',function(){
			var config = [{id:'1',homePage : '2',menu:[{text:'个人中心',
											...
											{id:'4',text:'修改密码',href:'<%=basePath%>user/editPasswordPage?userId=${userId}'}]}]},
										{id:'5',homePage : '6',menu:[{text:'container管理',
											items:[{id:'6',text:'container管理',href:'<%=basePath%>container/list?userId=${userId}'}]}]},
...
<div class="content">
    <div class="dl-main-nav">
        ...
        <ul id="J_Nav"  class="nav-list ks-clear">
			...
			<li class="nav-item dl-selected"><div class="nav-item-inner nav-order">container管理</div></li>
