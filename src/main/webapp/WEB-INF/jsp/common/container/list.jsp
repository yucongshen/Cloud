...
<body>
<form id="findForm" class="form-inline definewidth m20"  action="<%=basePath%>container/containerListById?userId=${userId}" method="post">
	container编号：
		...
		<th>操作</th>
   		...
   		<c:forEach items="${containerList }" var="container" varStatus="status">
	    	...
	    	<tr>
	    		...
	    		<td><a href="<%=basePath%>process/processByContainer?containerId=${container.containerId}&userId=${userId}">进入</a></td>
	    	</tr>
	    	</c:if>
    	</c:forEach>
</table>
